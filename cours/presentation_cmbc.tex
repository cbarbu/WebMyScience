...
\section{Site Web en Quarto/plotly}
  \begin{frame}{Quarto}
    ...
    \end{block}
  \end{frame}
%   \begin{frame}{Hello World en Quarto + plotly}
%     https://quarto.org/
%   \end{frame}
%   \begin{frame}{Etapes de l'atelier}
%     \begin{itemize}
%       \item Créer un site/blog quarto 
%       \item Ajouter du texte dépendant de code R
%       \item Ajouter un graphique dépendant de code R
%       \item Ajouter un graphique interactif avec Plotly
%     \end{itemize}
%     
%   \end{frame}
